...
import com.example.tolek.player.jaudiotagger.tag.aiff.AiffTag;
import com.example.tolek.player.jaudiotagger.tag.id3.AbstractID3v2Tag;
import com.example.tolek.player.jaudiotagger.tag.id3.ID3v22Tag;
import com.example.tolek.player.jaudiotagger.tag.id3.ID3v23Tag;
import com.example.tolek.player.jaudiotagger.tag.id3.ID3v24Tag;
