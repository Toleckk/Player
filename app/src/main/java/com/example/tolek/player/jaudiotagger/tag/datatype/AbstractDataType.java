...
public abstract class AbstractDataType
{
    ...
    //Logger
    public static Logger logger = Logger.getLogger("com.example.tolek.player.jaudiotagger.tag.datatype");
     ...
     *
     * @param arr
     * @throws com.example.tolek.player.jaudiotagger.tag.InvalidDataTypeException
     */
