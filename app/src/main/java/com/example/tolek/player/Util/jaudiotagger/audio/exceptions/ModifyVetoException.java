 ...
 * {@link com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener} wants to
 * prevent; from actually finishing its
 * operation.<br>
 * This exception can be used in all methods but
 * {@link com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener#fileOperationFinished(java.io.File)}.
 *
