...
import com.example.tolek.player.jaudiotagger.FileConstants;
...
import com.example.tolek.player.jaudiotagger.tag.datatype.DataTypes;
...
import com.example.tolek.player.jaudiotagger.tag.lyrics3.AbstractLyrics3;
import com.example.tolek.player.jaudiotagger.tag.lyrics3.Lyrics3v2;
import com.example.tolek.player.jaudiotagger.tag.lyrics3.Lyrics3v2Field;
import com.example.tolek.player.jaudiotagger.tag.reference.GenreTypes;
...
public class ID3v24Tag extends AbstractID3v2Tag
{
     ...
     * @param byteBuffer
     * @param size
     * @throws com.example.tolek.player.jaudiotagger.tag.InvalidTagException
     */
