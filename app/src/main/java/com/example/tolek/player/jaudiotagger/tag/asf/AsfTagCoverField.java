...
public class AsfTagCoverField extends AbstractAsfTagImageField
{
    ...
    public final static Logger LOGGER = Logger
            .getLogger("com.example.tolek.player.jaudiotagger.audio.asf.tag");
    ...
    private byte[] createRawContent(final byte[] data, final int pictureType,
        ...
        // ImageDataSize
        baos.write(com.example.tolek.player.jaudiotagger.audio.generic.Utils
    ...
    private void processRawContent() throws UnsupportedEncodingException {
        ...
        // ImageDataSize
        this.imageDataSize = com.example.tolek.player.jaudiotagger.audio.generic.Utils.getIntLE(this
                .getRawContent(), 1, 2);
