 ...
 */
package com.example.tolek.player.jaudiotagger.tag.id3;

import com.example.tolek.player.jaudiotagger.audio.AudioFile;
import com.example.tolek.player.jaudiotagger.audio.exceptions.UnableToCreateFileException;
import com.example.tolek.player.jaudiotagger.audio.exceptions.UnableToModifyFileException;
import com.example.tolek.player.jaudiotagger.audio.exceptions.UnableToRenameFileException;
...
import com.example.tolek.player.jaudiotagger.logging.FileSystemMessage;
import com.example.tolek.player.jaudiotagger.tag.*;
import com.example.tolek.player.jaudiotagger.tag.datatype.*;
import com.example.tolek.player.jaudiotagger.tag.id3.framebody.*;
import com.example.tolek.player.jaudiotagger.tag.id3.valuepair.TextEncoding;
import com.example.tolek.player.jaudiotagger.tag.images.Artwork;
import com.example.tolek.player.jaudiotagger.tag.reference.Languages;
import com.example.tolek.player.jaudiotagger.tag.reference.PictureTypes;
...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag
{
    ...
    */
     ...
     *
     * @see com.example.tolek.player.jaudiotagger.tag.Tag#hasField(java.lang.String)
     */
     ...
     * Is this tag empty
     *
     * @see com.example.tolek.player.jaudiotagger.tag.Tag#isEmpty()
     */
