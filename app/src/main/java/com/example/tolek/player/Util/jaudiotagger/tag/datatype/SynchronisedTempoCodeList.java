...
import com.example.tolek.player.Util.jaudiotagger.tag.id3.framebody.FrameBodySYTC;

/**
 * List of {@link com.example.tolek.player.Util.jaudiotagger.tag.datatype.SynchronisedTempoCode}s.
 *
...
public class SynchronisedTempoCodeList extends AbstractDataTypeList<SynchronisedTempoCode>
{
     ...
     * {@link com.example.tolek.player.Util.jaudiotagger.tag.datatype.AbstractDataTypeList#AbstractDataTypeList(com.example.tolek.player.Util.jaudiotagger.tag.datatype.AbstractDataTypeList)}.
     *
