...
import com.example.tolek.player.jaudiotagger.audio.flac.metadatablock.BlockType;
import com.example.tolek.player.jaudiotagger.audio.flac.metadatablock.MetadataBlockDataPadding;
import com.example.tolek.player.jaudiotagger.audio.flac.metadatablock.MetadataBlockDataPicture;
import com.example.tolek.player.jaudiotagger.audio.flac.metadatablock.MetadataBlockHeader;
import com.example.tolek.player.jaudiotagger.audio.generic.AbstractTagCreator;
import com.example.tolek.player.jaudiotagger.tag.Tag;
import com.example.tolek.player.jaudiotagger.tag.flac.FlacTag;
import com.example.tolek.player.jaudiotagger.tag.vorbiscomment.VorbisCommentCreator;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.jaudiotagger.audio.flac");
