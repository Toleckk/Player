package com.example.tolek.player.jaudiotagger.audio.flac.metadatablock;
...
public class MetadataBlockDataPicture implements MetadataBlockData, TagField
{
    ...
    // Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.jaudiotagger.audio.flac.MetadataBlockDataPicture");
     ...
     * {@link com.example.tolek.player.jaudiotagger.audio.generic.AbstractTag} will use the &quot;id&quot; to summarize multiple
     * fields.
     *
