...
import com.example.tolek.player.Util.jaudiotagger.audio.exceptions.CannotReadVideoException;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.Util.jaudiotagger.audio.mp4.atom");
