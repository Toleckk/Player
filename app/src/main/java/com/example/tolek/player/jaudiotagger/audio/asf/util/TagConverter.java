 ...
 */
package com.example.tolek.player.jaudiotagger.audio.asf.util;

import com.example.tolek.player.jaudiotagger.audio.asf.data.*;
import com.example.tolek.player.jaudiotagger.tag.FieldKey;
import com.example.tolek.player.jaudiotagger.tag.Tag;
import com.example.tolek.player.jaudiotagger.tag.asf.*;
 ...
 * {@link com.example.tolek.player.jaudiotagger.audio.asf.data.AsfHeader}objects into
 * {@link com.example.tolek.player.jaudiotagger.tag.Tag}objects.<br>
 * 
