package com.example.tolek.player.Util.jaudiotagger.audio.mp4;

import com.example.tolek.player.Util.jaudiotagger.utils.tree.DefaultMutableTreeNode;
import com.example.tolek.player.Util.jaudiotagger.utils.tree.DefaultTreeModel;
import com.example.tolek.player.Util.jaudiotagger.audio.exceptions.CannotReadException;
import com.example.tolek.player.Util.jaudiotagger.audio.exceptions.NullBoxIdException;
import com.example.tolek.player.Util.jaudiotagger.audio.mp4.atom.Mp4BoxHeader;
import com.example.tolek.player.Util.jaudiotagger.audio.mp4.atom.Mp4MetaBox;
import com.example.tolek.player.Util.jaudiotagger.audio.mp4.atom.Mp4StcoBox;
import com.example.tolek.player.Util.jaudiotagger.audio.mp4.atom.NullPadding;
...
public class Mp4AtomTree
{
    ...
    //Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.Util.jaudiotagger.audio.mp4");
