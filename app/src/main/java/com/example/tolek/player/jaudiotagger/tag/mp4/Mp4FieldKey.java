...
import com.example.tolek.player.jaudiotagger.tag.mp4.field.Mp4TagReverseDnsField;
import com.example.tolek.player.jaudiotagger.tag.reference.Tagger;

import static com.example.tolek.player.jaudiotagger.tag.mp4.field.Mp4FieldType.*;
