...
import com.example.tolek.player.jaudiotagger.tag.id3.framebody.FrameBodyDeprecated;
import com.example.tolek.player.jaudiotagger.tag.id3.framebody.FrameBodyUnsupported;
...
public class ID3v22Frame extends AbstractID3v2Frame
{
    ...
    public ID3v22Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("com.example.tolek.player.jaudiotagger.tag.id3.framebody.FrameBody" + bodyIdentifier);
