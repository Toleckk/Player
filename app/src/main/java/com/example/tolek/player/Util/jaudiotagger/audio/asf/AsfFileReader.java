 ...
 */
package com.example.tolek.player.Util.jaudiotagger.audio.asf;

import com.example.tolek.player.Util.jaudiotagger.audio.AudioFile;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.data.AsfHeader;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.data.AudioStreamChunk;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.data.MetadataContainer;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.data.MetadataDescriptor;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.io.*;
import com.example.tolek.player.Util.jaudiotagger.tag.asf.AsfTag;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.util.TagConverter;
import com.example.tolek.player.Util.jaudiotagger.audio.asf.util.Utils;
...
import com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileReader;
import com.example.tolek.player.Util.jaudiotagger.audio.generic.GenericAudioHeader;
...
public class AsfFileReader extends AudioFileReader {
    ...
    private final static Logger LOGGER = Logger
            .getLogger("com.example.tolek.player.Util.jaudiotagger.audio.asf");
     ...
     * (overridden)
     * 
     * @see com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileReader#getEncodingInfo(java.io.RandomAccessFile)
     */
    @Override
     ...
     * (overridden)
     * 
     * @see com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileReader#getTag(java.io.RandomAccessFile)
     */
    @Override
