 ...
 */
package com.example.tolek.player.jaudiotagger.tag.vorbiscomment;

import com.example.tolek.player.jaudiotagger.audio.flac.metadatablock.MetadataBlockDataPicture;
import com.example.tolek.player.jaudiotagger.audio.generic.AbstractTag;
import com.example.tolek.player.jaudiotagger.audio.generic.Utils;
import com.example.tolek.player.jaudiotagger.audio.ogg.util.VorbisHeader;
...
import static com.example.tolek.player.jaudiotagger.tag.vorbiscomment.VorbisCommentFieldKey.VENDOR;

import com.example.tolek.player.jaudiotagger.tag.id3.valuepair.TextEncoding;
import com.example.tolek.player.jaudiotagger.tag.images.ArtworkFactory;
import com.example.tolek.player.jaudiotagger.tag.vorbiscomment.util.Base64Coder;
...
public class VorbisCommentTag extends AbstractTag
{
     ...
     * @param value
     * @return
     * @throws com.example.tolek.player.jaudiotagger.tag.KeyNotFoundException
     * @throws com.example.tolek.player.jaudiotagger.tag.FieldDataInvalidException
     */
