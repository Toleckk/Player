...
package com.example.tolek.player.Util.jaudiotagger.tag.lyrics3;

import com.example.tolek.player.Util.jaudiotagger.tag.InvalidTagException;
...
import com.example.tolek.player.Util.jaudiotagger.tag.id3.AbstractID3v2Frame;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.AbstractTagFrame;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.framebody.AbstractFrameBodyTextInfo;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.framebody.FrameBodyCOMM;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.framebody.FrameBodySYLT;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.framebody.FrameBodyUSLT;
