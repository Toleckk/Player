...
import com.example.tolek.player.jaudiotagger.tag.mp4.Mp4FieldKey;
import com.example.tolek.player.jaudiotagger.tag.mp4.Mp4NonStandardFieldKey;
import com.example.tolek.player.jaudiotagger.tag.mp4.Mp4Tag;
import com.example.tolek.player.jaudiotagger.tag.mp4.atom.Mp4DataBox;
import com.example.tolek.player.jaudiotagger.tag.mp4.field.*;
...
public class Mp4TagReader
{
    ...
    // Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.jaudiotagger.tag.mp4");
