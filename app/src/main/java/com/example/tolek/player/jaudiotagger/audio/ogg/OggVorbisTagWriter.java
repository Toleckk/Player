...
import com.example.tolek.player.jaudiotagger.audio.ogg.util.OggCRCFactory;
...
public class OggVorbisTagWriter
{
     ...
     * @throws com.example.tolek.player.jaudiotagger.audio.exceptions.CannotWriteException
     */
