...
import com.example.tolek.player.Util.jaudiotagger.tag.aiff.AiffTag;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.AbstractID3v2Tag;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.ID3v22Tag;
import com.example.tolek.player.Util.jaudiotagger.tag.id3.ID3v23Tag;
