 ...
 */
package com.example.tolek.player.jaudiotagger.audio.ogg.util;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.jaudiotagger.audio.ogg.atom");
