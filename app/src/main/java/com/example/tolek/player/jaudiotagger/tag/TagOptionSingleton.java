 ...
 *
 */
package com.example.tolek.player.jaudiotagger.tag;

import com.example.tolek.player.jaudiotagger.tag.id3.framebody.AbstractID3v2FrameBody;
import com.example.tolek.player.jaudiotagger.tag.id3.framebody.FrameBodyCOMM;
import com.example.tolek.player.jaudiotagger.tag.id3.framebody.FrameBodyTIPL;
import com.example.tolek.player.jaudiotagger.tag.id3.framebody.ID3v24FrameBody;
import com.example.tolek.player.jaudiotagger.tag.id3.valuepair.TextEncoding;
import com.example.tolek.player.jaudiotagger.tag.lyrics3.Lyrics3v2Fields;
import com.example.tolek.player.jaudiotagger.tag.options.PadNumberOption;
import com.example.tolek.player.jaudiotagger.tag.reference.GenreTypes;
import com.example.tolek.player.jaudiotagger.tag.reference.ID3V2Version;
