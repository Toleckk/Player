...
import com.example.tolek.player.jaudiotagger.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link com.example.tolek.player.jaudiotagger.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link com.example.tolek.player.jaudiotagger.tag.id3.framebody.FrameBodySYTC}
 *
