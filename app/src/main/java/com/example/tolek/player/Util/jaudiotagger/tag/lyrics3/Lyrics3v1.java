...
import com.example.tolek.player.Util.jaudiotagger.tag.id3.ID3Tags;
...
public class Lyrics3v1 extends AbstractLyrics3
{
    ...
    {
        /**
         * @todo Implement this com.example.tolek.player.Util.jaudiotagger.tag.AbstractMP3Tag abstract method
         */
