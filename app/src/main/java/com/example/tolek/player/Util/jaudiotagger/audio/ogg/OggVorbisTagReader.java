 ...
 */
package com.example.tolek.player.Util.jaudiotagger.audio.ogg;
...
import com.example.tolek.player.Util.jaudiotagger.audio.ogg.util.OggPageHeader;
import com.example.tolek.player.Util.jaudiotagger.audio.ogg.util.VorbisHeader;
import com.example.tolek.player.Util.jaudiotagger.audio.ogg.util.VorbisPacketType;
...
import com.example.tolek.player.Util.jaudiotagger.tag.vorbiscomment.VorbisCommentReader;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.example.tolek.player.Util.jaudiotagger.audio.ogg");
