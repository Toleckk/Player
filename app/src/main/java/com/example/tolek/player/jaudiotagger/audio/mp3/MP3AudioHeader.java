...
import com.example.tolek.player.jaudiotagger.audio.AudioHeader;
...
public class MP3AudioHeader implements AudioHeader
{
    ...
    //Logger
    public static Logger logger = Logger.getLogger("com.example.tolek.player.jaudiotagger.audio.mp3");
