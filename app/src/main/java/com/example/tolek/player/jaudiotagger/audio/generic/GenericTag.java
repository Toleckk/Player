 ...
 */
package com.example.tolek.player.jaudiotagger.audio.generic;

import com.example.tolek.player.jaudiotagger.logging.ErrorMessage;
import com.example.tolek.player.jaudiotagger.tag.*;
import com.example.tolek.player.jaudiotagger.tag.images.Artwork;
...
public abstract class GenericTag extends AbstractTag
{
    ...
    private class GenericTagTextField implements TagTextField
    {
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#copyContent(com.example.tolek.player.jaudiotagger.tag.TagField)
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagTextField#getContent()
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagTextField#getEncoding()
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#getId()
         */
        public String getId()
        {
            return id;
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#getRawContent()
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#isBinary()
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#isBinary(boolean)
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#isCommon()
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagField#isEmpty()
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagTextField#setContent(java.lang.String)
         */
         ...
         * (overridden)
         *
         * @see com.example.tolek.player.jaudiotagger.tag.TagTextField#setEncoding(java.lang.String)
         */
     ...
     * (overridden)
     *
     * @see com.example.tolek.player.jaudiotagger.audio.generic.AbstractTag#isAllowedEncoding(java.lang.String)
     */
