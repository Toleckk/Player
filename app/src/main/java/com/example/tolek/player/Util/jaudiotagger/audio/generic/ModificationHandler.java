 ...
 */
package com.example.tolek.player.Util.jaudiotagger.audio.generic;

import com.example.tolek.player.Util.jaudiotagger.audio.AudioFile;
import com.example.tolek.player.Util.jaudiotagger.audio.exceptions.ModifyVetoException;
...
public class ModificationHandler implements AudioFileModificationListener
{
     ...
     * (overridden)
     *
     * @see com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener#fileModified(com.example.tolek.player.Util.jaudiotagger.audio.AudioFile,
     *File)
     */
     ...
     * (overridden)
     *
     * @see com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener#fileOperationFinished(File)
     */
     ...
     * (overridden)
     *
     * @see com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener#fileWillBeModified(com.example.tolek.player.Util.jaudiotagger.audio.AudioFile,
     *boolean)
     */
     ...
     * (overridden)
     *
     * @see com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener#vetoThrown(com.example.tolek.player.Util.jaudiotagger.audio.generic.AudioFileModificationListener,
     * com.example.tolek.player.Util.jaudiotagger.audio.AudioFile,
     * com.example.tolek.player.Util.jaudiotagger.audio.exceptions.ModifyVetoException)
     */
