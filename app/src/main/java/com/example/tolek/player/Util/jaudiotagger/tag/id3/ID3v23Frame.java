...
import com.example.tolek.player.Util.jaudiotagger.logging.Hex;
import com.example.tolek.player.Util.jaudiotagger.tag.EmptyFrameException;
import com.example.tolek.player.Util.jaudiotagger.tag.InvalidDataTypeException;
import com.example.tolek.player.Util.jaudiotagger.tag.InvalidFrameException;
import com.example.tolek.player.Util.jaudiotagger.tag.InvalidFrameIdentifierException;
...
import com.example.tolek.player.Util.jaudiotagger.utils.EqualsUtil;
...
public class ID3v23Frame extends AbstractID3v2Frame
{
     ...
     *
     * @param frame
     * @throws com.example.tolek.player.Util.jaudiotagger.tag.InvalidFrameException
     */
